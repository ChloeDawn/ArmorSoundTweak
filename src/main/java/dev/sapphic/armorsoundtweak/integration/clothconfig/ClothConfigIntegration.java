...
public final class ClothConfigIntegration {
  ...
  public static Screen buildConfigScreen(final Screen parent) {
    final var screen = ConfigBuilder.create()
        .setTitle(Component.translatable(ArmorSoundTweak.MOD_ID))
        .setSavingRunnable(ArmorSoundTweak::saveConfig)
        .setParentScreen(parent);

    final var entries = screen.entryBuilder();

    screen.getOrCreateCategory(Component.translatable(SOUNDS_CONFIG))
        .addEntry(entries.startBooleanToggle(
                Component.translatable(ARMOR_CONFIG),
        ...
        .addEntry(entries.startBooleanToggle(
                Component.translatable(ELYTRA_CONFIG),
        ...
        .addEntry(entries.startBooleanToggle(
                Component.translatable(SKULLS_CONFIG),
        ...
        .addEntry(entries.startBooleanToggle(
                Component.translatable(PUMPKINS_CONFIG),
        ...
        .addEntry(entries.startBooleanToggle(
                Component.translatable(ANYTHING_CONFIG),
